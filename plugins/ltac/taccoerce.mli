...
sig
  ...
  val of_uconstr : Glob_ops.closed_glob_constr -> t
  val to_uconstr : t -> Glob_ops.closed_glob_constr option
  val of_int : int -> t
...
val coerce_to_constr : Environ.env -> Value.t -> Glob_ops.constr_under_binders

val coerce_to_uconstr : Environ.env -> Value.t -> Glob_ops.closed_glob_constr
...
val wit_constr_under_binders : (Empty.t, Empty.t, Glob_ops.constr_under_binders) genarg_type
