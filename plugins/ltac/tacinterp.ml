...
let () =
  ...
  register_interp0 wit_reference (lift interp_reference);
  register_interp0 wit_preident (lift interp_pre_ident);
  ...
  register_interp0 wit_clause (lift interp_clause);
  ...
  register_interp0 wit_quantified_hypothesis (lift interp_declared_or_quantified_hypothesis);
