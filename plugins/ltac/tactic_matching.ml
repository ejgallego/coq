...
type 'a t = {
  subst : Constr_matching.bound_ident_map * Glob_ops.extended_patvar_map ;
...
let adjust : Constr_matching.bound_ident_map * Glob_ops.patvar_map ->
             Constr_matching.bound_ident_map * Glob_ops.extended_patvar_map =
